package com.kororia.fshop.home.view;
...
import com.kororia.fshop.post.view.NewPostActivity;
...
public class HomeFragment extends BaseFragment implements HomeView {
            ...
            public void onClick(View v) {
                ...
                if (canUseCamera != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(_activity,
                        ...
                        ActivityCompat.requestPermissions(_activity, new String[]{Manifest.permission.CAMERA}, FShopApp.PERMISSION_REQUEST_CAMERA);
                    }
                } else {
                    newPost();
                }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode) {
            case FShopApp.PERMISSION_REQUEST_CAMERA:
        ...
        if (componentName != null) {
            ...
            try {
                ...
                if (photoFile != null) {
                    ...
                    startActivityForResult(intent, FShopApp.PERMISSION_REQUEST_CAMERA);
                }
            } catch (Exception e) {
